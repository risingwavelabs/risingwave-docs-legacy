...
- Breaking change: Deprecates `CREATE MATERIALIZED SOURCE` . To create a materialized source, create a table and include the newly added connector settings. [#7110](https://github.com/risingwavelabs/risingwave/pull/7281https://github.com/risingwavelabs/risingwave/pull/7110)
...
- Adds support for display PostgreSQL and RisingWave version in `version()`. [#7314](https://github.com/risingwavelabs/risingwave/pull/7314)
