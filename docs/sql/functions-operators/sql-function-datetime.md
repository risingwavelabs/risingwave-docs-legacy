...
| to_timestamp( *string*, *timestamp_format* ) → *timestamp* |Converts string to timestamp according to the given format. |`to_timestamp('2022 12 25', 'YYYY MM DD')` → `2022-12-25 00:00:00`|