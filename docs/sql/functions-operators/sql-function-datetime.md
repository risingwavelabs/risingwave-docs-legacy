...
| to_char ( *timestampz*, *format* ) → *string* |Converts timestamp to string according to the given format. Both uppercase and lowercase formats are supported.|`to_char('2023-07-12 03:01:00+00:00', 'HH12:MI:SS')` → `03:01:00` <br /> `to_char('2006-01-02 15:04:05.003', 'YYYY-MM-DD HH24:MI:SS.MS')` → `2006-01-02 15:04:05.003`|
