...
|---|---|---|
| count( *timestamptz* ) → *numeric_output* | Returns the count of non-`NULL` *timestamptz* values in a given set or column. | `count('2022-10-01 12:00:00-08:00'::timestamp with time zone)` → `1` |
...
| max( *timestamptz* ) → *timestamptz_output* | Returns the maximum (latest) value among all *timestamptz* values in a given set or column. | `max('2022-10-01 12:00:00-08:00'::timestamp with time zone)` → `2022-10-01 20:00:00+00:00` |
| min( *timestamptz* ) → *timestamptz_output* | Returns the minimum (earliest) value among all *timestamptz* values in a given set or column. | `min('2022-10-01 12:00:00-08:00'::timestamp with time zone)` → `2022-10-01 20:00:00+00:00` |
...
| to_timestamp ( *string*, *timestamp_format* ) → *timestamp* |Converts string to timestamp according to the given format. |<ul><li>`to_timestamp('2022 12 25', 'YYYY MM DD')` → `2022-12-25 00:00:00`</li><li>`to_timestamp('2022/12/25 10:24:33', 'YYYY/MM/DD HH12:MI:SS')` → `2022-12-25 10:24:33` </li><li>`to_timestamp('2022/12/25 15', 'YYYY/MM/DD HH24')` → `2022-12-25 15:00:00`</li></ul>  |
