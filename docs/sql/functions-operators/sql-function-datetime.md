...
| to_timestamp ( *seconds_double_precision* ) → *timestamp_with_time_zone_output* <br /> to_timestamp ( *text*, *text* ) → *text* |Converts Unix epoch seconds (the number of seconds since 1970-01-01 00:00:00+00) to timestamp with time zone. Also, converts string to time stamp according to the given format.|`to_timestamp(1262349296.7890123)` → `2010-01-01 12:34:56.789012+00:00` <br /> `to_timestamp('2022 12 25', 'YYYY MM DD')` → `2022-12-25 00:00:00`|
