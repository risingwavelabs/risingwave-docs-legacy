...
| to_char ( *timestamptz*, *format* ) → *string* <br /><br /> to_char ( *timestamp*, *format* ) → *string* |Converts the input to string according to the given format. Both uppercase and lowercase formats are supported.| `to_char('2023-07-11 20:01:00-07:00'::timestamptz, 'HH12:MI:SS TZH:TZM') → 03:01:00 +00:00` <br /><br /> `to_char(timestamp '2002-04-20 17:31:12.66', 'HH12:MI:SS')` → `05:31:12`|
