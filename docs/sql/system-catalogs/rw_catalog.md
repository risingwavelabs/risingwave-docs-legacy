...
|---|---|
 ...
 rw_description        | Contains optional comments for each database object. Descriptions can be added with the `COMMENT ON` command and viewed with `DESCRIBE` or `SHOW COLUMNS IN` command.|
