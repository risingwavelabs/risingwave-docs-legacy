...
rw_actor_id_to_ddl | Contains information about the participants who executed the database schema change operations (DDL) and their corresponding `actor_id` identifiers. The outputs include:<ul> <li>actor_id: Unique identifier for the participant who executed the DDL operation</li> <li>fragment_id: Links to the `fragment_id` in `rw_fragment_id_to_ddl`, identifying the specific DDL operation</li> <li>job_id: The job in which the DDL operation was executed</li> <li>schema_id: The database schema in which the DDL operation was executed</li> <li>ddl_type: The type of DDL operation (e.g. "table", "view")</li> <li>name: The name of the affected object</li> </ul>|
 ...
 rw_fragment_id_to_ddl|Contains information about the database schema change operations (DDL) and their corresponding `fragment_id` identifiers. The outputs inlude: <ul> <li>fragment_id: Unique identifier for a specific DDL operation</li> <li>job_id: The job in which the DDL operation was executed</li> <li>schema_id: The database schema in which the DDL operation was executed</li> <li>ddl_type: The type of DDL operation (e.g. "table", "view")</li> <li>name: The name of the affected object</li> </ul> |
