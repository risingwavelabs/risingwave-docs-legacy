...
:::note
The Python UDF SDK has been updated since version 1.9. If you're currently using RisingWave 1.10, we strongly encourage you to update to the latest version. Older versions are still supported.
:::
