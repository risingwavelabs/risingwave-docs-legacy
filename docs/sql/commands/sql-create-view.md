...
The following statement shows how to create views based on a user-defined table and a materialized source (whose data is generated by the built-in [load generator](../create-source/create-source-datagen.md)), and then create a new view based on the existing views.
