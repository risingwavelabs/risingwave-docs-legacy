...
The following statements create views based a batch table and a table that consumes streaming data, and then create a new view based on the existing views. The data for the table is generated by the built-in [load generator](/ingest/ingest-from-datagen.md).
