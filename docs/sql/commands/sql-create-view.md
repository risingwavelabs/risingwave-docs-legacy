...
The following statement shows how to create views based on a user-defined table and a materialized source. And then create a view based on existing views.
