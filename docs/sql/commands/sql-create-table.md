...
To know when a data record is loaded to RisingWave, you can define a column that is generated based on the processing time (`<column_name> AS proctime()`) when creating the table or source.
