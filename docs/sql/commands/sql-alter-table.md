...
+ If your table is defined with a schema registry, its column can not be altered. However, if the table with a schema registry has generated columns, you can drop the generated columns, and note dropping these generated columns will trigger refreshing schema.
