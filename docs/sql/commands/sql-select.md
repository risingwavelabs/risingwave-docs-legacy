...
|**VALUES** clause          | This clause generate one or more rows of data as a table expression. For details, see [VALUES clause](../query-syntax/query-syntax-values-clause.md).|
