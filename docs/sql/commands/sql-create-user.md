...
| <ul><li>LOGIN</li><li>NOLOGIN</li></ul> | Grants/denies the user the ability to log in when [establishing connection with RisingWave](../install-run-connect.md/#connect-to-risingwave). <br/> LOGIN is the default value. |
