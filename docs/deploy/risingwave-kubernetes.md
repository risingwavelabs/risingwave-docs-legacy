...
1. In the `risingwave.yaml` file that you use to deploy a RisingWave instance, add a `frontendServiceType` parameter to the configuration of the frontend service, and set its value to `NodePort`.
