...
You can also use the [`ALTER SYSTEM SET`](/sql/commands/sql-alter-system.md) command to set a system-wide default value for a session parameter, from which parameters in a new session will be initialized.
