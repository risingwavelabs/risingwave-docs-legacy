...
| streaming_rate_limit                  | 0               | Set the maximum number of records per second per source. The source here refers to an upstream source or snapshot read in the backfilling process.    |
