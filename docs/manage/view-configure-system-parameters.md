...
|`wasm_storage_url`||
|`enable_tracing`|This parameter is used to togglle the opentelemetry tracing during runtime. It is only used to toggle the functionality, not to specify the endpoint URL. Its default value is `false`.|
