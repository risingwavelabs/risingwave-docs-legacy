...
|server.id| Optional. A numeric ID of the database client. It must be unique across all database processes that are running in the MySQL cluster. It not specified, RisingWave will generate a random ID.|
