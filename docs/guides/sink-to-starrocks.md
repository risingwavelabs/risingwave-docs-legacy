...
| starrocks.query_port | The port address that connects to the frontend client. By default, this is `9030`.|
| starrocks.http_port | The http port for data import. By default, this is `8030`. |
