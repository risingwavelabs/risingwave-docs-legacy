...
| PostgreSQL type | RisingWave type | Literal type |
|------------|-----------------|--------------|
|BOOLEAN	|BOOLEAN	|BOOLEAN|
|BIT(1)	|BOOLEAN	|BOOLEAN|
|BIT( > 1)	|No support	|BYTES|
|BIT VARYING[(M)]	|No support	|BYTES|
|SMALLINT, SMALLSERIAL	|SMALLINT	|INT16|
|INTEGER, SERIAL|	INTEGER	|INT32|
|BIGINT, BIGSERIAL, OID	|BIGINT	|INT64|
|REAL	|REAL	|FLOAT32|
|DOUBLE PRECISION|	DOUBLE PRECISION	|FLOAT64|
|CHAR[(M)]	|CHARACTER VARYING	|STRING|
|VARCHAR[(M)]	|CHARACTER VARYING|	STRING|
|CHARACTER[(M)]	|CHARACTER VARYING	|STRING|
|CHARACTER VARYING[(M)]	|CHARACTER VARYING|	STRING|
|TIMESTAMPTZ, TIMESTAMP WITH TIME ZONE	|TIMESTAMP WITH TIME ZONE|	STRING|
|TIMETZ, TIME WITH TIME ZONE|	TIME WITHOUT TIME ZONE (assume UTC time zone) |STRING|
|INTERVAL [P]	|INTERVAL	|STRING|
|BYTEA	|BYTEA	|BYTES or STRING|
|JSON, JSONB	|JSONB	|STRING|
|XML	|CHARACTER VARYING	|STRING|
|UUID	|CHARACTER VARYING	|STRING|
|POINT	|STRUCT	(with form `<x REAL, y REAL>`)|STRUCT|
|LTREE	|No support	|STRING|
|CITEXT	|CHARACTER VARYING*	|STRING|
|INET	|CHARACTER VARYING*	|STRING|
|INT4RANGE	|CHARACTER VARYING*	|STRING|
|INT8RANGE	|CHARACTER VARYING*	|STRING|
|NUMRANGE	|CHARACTER VARYING*	|STRING|
|TSRANGE	|CHARACTER VARYING*	|STRING|
|TSTZRANGE	|CHARACTER VARYING*	|STRING|
|DATERANGE	|CHARACTER VARYING*	|STRING|
|ENUM	|CHARACTER VARYING*	|STRING|
|DATE	|DATE	|INT32|
|TIME(1), TIME(2), TIME(3), TIME(4), TIME(5), TIME(6)	|TIME WITHOUT TIME ZONE (limited to `[1973-03-03 09:46:40, 5138-11-16 09:46:40)`)|INT64|
|TIMESTAMP(1), TIMESTAMP(2), TIMESTAMP(3)	|TIMESTAMP WITHOUT TIME ZONE (limited to `[1973-03-03 09:46:40, 5138-11-16 09:46:40)`) |INT64|
|TIMESTAMP(4), TIMESTAMP(5), TIMESTAMP(6), TIMESTAMP|	TIMESTAMP WITHOUT TIME ZONE|	INT64|
|NUMERIC[(M[,D])]	|NUMERIC	|BYTES|
|DECIMAL[(M[,D])]	|NUMERIC	|BYTES|
|MONEY[(M[,D])]	|NUMERIC	|BYTES|
|HSTORE	|No support	|STRING|
|HSTORE	|No support	|MAP|
|INET	|CHARACTER VARYING*	|STRING|
|CIDR	|CHARACTER VARYING*	|STRING|
|MACADDR	|CHARACTER VARYING*	|STRING|
|MACADDR8	|CHARACTER VARYING*	|STRING|