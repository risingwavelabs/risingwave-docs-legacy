...
|Vector| |Available. |
|migrate| |Available. `migrate` is a powerful tool written in Go for managing database migrations. For dtails, see [its introduction and tutorial](https://github.com/risingwavelabs/migrate?tab=readme-ov-file).|
