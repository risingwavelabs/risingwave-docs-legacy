...
:::info
The following options start RisingWave in the single-node mode. In this mode, data is stored in the file system and the metadata is stored in the embedded SQLite database.
