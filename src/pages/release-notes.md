...
- SQL commands
  - Supports `COMMENT ON` clause for tables and columns. [#12849](https://github.com/risingwavelabs/risingwave/pull/12849). [See documentation.](/docs/current/sql-comment-on/)
  - Supports persistent background materialized views. [#12167](https://github.com/risingwavelabs/risingwave/pull/12167). [See documentation.](/docs/current/sql-set-background-ddl)
...
- SQL functions & operators
  - Supports `substring` and `substr` functions for `bytea` data type. [#13088](https://github.com/risingwavelabs/risingwave/pull/13088). [See string function. ](/docs/current/sql-function-string/#substrsubstring)[See bit function.](/docs/current/sql-function-binarystring/#substr)
  - Supports functions `jsonb_pretty`,  `jsonb_object`, `jsonb_strip_nulls`, and `jsonb_extract_path`. [#13050](https://github.com/risingwavelabs/risingwave/pull/13050), [#13036](https://github.com/risingwavelabs/risingwave/pull/13036), [#13169](https://github.com/risingwavelabs/risingwave/pull/13169), [#13143](https://github.com/risingwavelabs/risingwave/pull/13143). [See documentation.](/docs/current/sql-function-json/#json-functions)
  - Supports jsonb `@>`, `<@`, `?`, `?|, ?&`, `#>`,  `#>>`, `-` and `#-` operators.  [#13056](https://github.com/risingwavelabs/risingwave/pull/13056), [#13110](https://github.com/risingwavelabs/risingwave/pull/13110), [#13118](https://github.com/risingwavelabs/risingwave/pull/13118). [See documentation.](/docs/current/sql-function-json/#json-operators)
  - Supports `greatest` and `least` functions. [#12838](https://github.com/risingwavelabs/risingwave/pull/12838). [See documentation.](/docs/current/sql-function-conditional/#greatest)
  - Supports `regexp_split_to_array` function. [#12844](https://github.com/risingwavelabs/risingwave/pull/12844). [See documentation](/docs/current/sql-function-string/#regexp_split_to_array)
  - Supports `bit_and` and `bit_or` aggregate functions in materialized views. [#12758](https://github.com/risingwavelabs/risingwave/pull/12758). [See documentation](/docs/current/sql-function-aggregate/#bit_and)
  - Supports `jsonb_agg` and `jsonb_object_agg` in streaming mode. [#12836](https://github.com/risingwavelabs/risingwave/pull/12836). [See documentation.](/docs/current/sql-function-aggregate/#jsonb_agg)
  - Supports general `rank` and `dense_rank` window functions. [#13183](https://github.com/risingwavelabs/risingwave/pull/13183). [See documentation.](/docs/current/window-functions)
- System catalog
...
- Adds `google.protobuf.Any` support for Protobuf sources. [#12291](https://github.com/risingwavelabs/risingwave/pull/12291). [See documentation.](/docs/current/protobuf-types)
- Adds `schemas.enable` support for Kafka sinks with upsert JSON. [#12113](https://github.com/risingwavelabs/risingwave/pull/12113). [See documentation.](/docs/current/create-sink-kafka/#sink-parameters)
- Adds support for Kafka sinks with upsert Avro using schema registry. [#13007](https://github.com/risingwavelabs/risingwave/pull/13007). [See documentation.](/docs/current/create-sink-kafka/#avro-specific-parameters)
- `server.id` option is now optional for MySQL CDC source. [#13031](https://github.com/risingwavelabs/risingwave/pull/13031)
- Enables `timestamptz.handling.mode` option to control the timestamptz output format for certain sinks. [#13109](https://github.com/risingwavelabs/risingwave/pull/13109). [See Kafka sink.](/docs/current/create-sink-kafka/#sink-parameters) [See AWS Kinesis sink.](/docs/current/sink-to-aws-kinesis/#sink-parameters) [See Pulsar sink.](/docs/current/sink-to-pulsar/#sink-parameters)
- Adds the `stream` field and support for multiple inputs for the `subject` field for NATS source connector. [#12799](https://github.com/risingwavelabs/risingwave/pull/12799). [See documentation.](/docs/current/ingest-from-nats)
- Adds new option `properties.allow.auto.create.topics` for Kafka sink. [#12766](https://github.com/risingwavelabs/risingwave/pull/12766). [See documentation.](/docs/current/create-sink-kafka/#additional-kafka-parameters)
- Adds support for `s3_v2` source connector, a more efficient version of the S3 source. [#12595](https://github.com/risingwavelabs/risingwave/pull/12595). [See documentation.](/docs/current/ingest-from-s3)
- Adds support for Google BigQuery sink.[#12873](https://github.com/risingwavelabs/risingwave/pull/12873). [See documentation.](/docs/current/sink-to-bigquery)
- Adds support for Redis sink. [#11999](https://github.com/risingwavelabs/risingwave/pull/11999),[#13003](https://github.com/risingwavelabs/risingwave/pull/13003). [See documentation.](/docs/current/sink-to-redis)
