...
/>
  ...
  scripts: [
    ...
    {
      src: "https://cdn.jsdelivr.net/npm/@runllm/search-widget@0.0.1-alpha57/dist/run-llm-search-widget.es.js",
  ...
  stylesheets: ["https://cdn.jsdelivr.net/npm/@runllm/search-widget@0.0.1-alpha57/dist/main.css"],
  webpack: {
    jsLoader: (isServer) => ({
